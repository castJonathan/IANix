...
/**
 * Created by Jonathan on 01/10/2015.
 */
...
public class AlarmNotificationReceiver  extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mNotificationIntent = new Intent(context, alarma.class);
        ...
        Log.e("notificacion", "Sending notification at:"+ DateFormat.getDateTimeInstance().format(new Date()));
